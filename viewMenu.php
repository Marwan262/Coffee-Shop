 ...
 <html lang="en" dir="ltr">
   ...
   <body>
        ...
        <table width="30%" border="1" style="border-collapse:collapse; margin-top:4px;">
             ...
             <tbody>
               ...
               while ($row2 = mysqli_fetch_array($result2)) {
                 ...
                 echo "<td><input type='radio' class = 'condiment' id='condiment' name='condiment' value='" . $row2['Name'] . "'></td>";
                 echo "</tr>";
               }
                ?>
             </tbody>
     ...
     <div class="">
        ...
        <table width="30%" border="1" style="border-collapse:collapse; margin-top:4px;">
             ...
             <tbody>
               ...
               while ($row3 = mysqli_fetch_array($result3)) {
                 ...
                 echo "<td><input type='radio' class = 'milk' id='milk' name='milk' value='" . $row3['Type'] . "'></td>";
                 echo "</tr>";
               }
                ?>
             </tbody>
       ...
       <input type="button" name="" value="View Cart" onclick="checkout()">
   </body>
 </html>
